...
export interface ApiGameCardGameCard extends Struct.CollectionTypeSchema {
  collectionName: 'game_cards';
  info: {
    displayName: 'game-cards';
...
export interface ApiMainCardMainCard extends Struct.CollectionTypeSchema {
...
export interface ApiProductVariationProductVariation
  ...
  attributes: {
    ...
    duration_unit: Schema.Attribute.Enumeration<
    ...
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    product_codes: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    stock_status: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activation_instructions: Schema.Attribute.RichText;
    ...
    > &
      Schema.Attribute.Private;
    publication_state: Schema.Attribute.Enumeration<['draft', 'published']>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSubmenuItemSubmenuItem extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::submenu-item.submenu-item': ApiSubmenuItemSubmenuItem;
